...
class Tracker:
    ...
    # ---------------------------
    # Add position (foot/center) to tracks
    # ---------------------------
    ...
    # ---------------------------
    # Draw ellipse under player/referee
    # ---------------------------
    ...
    # ---------------------------
    # Draw triangle marker (ball/has_ball)
    # ---------------------------
    ...
    # ---------------------------
    # Final Annotation (players, refs, ball)
    # ---------------------------
